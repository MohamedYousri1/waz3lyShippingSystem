...
@Component({
  selector: 'app-edit-add-sales',
  templateUrl: './edit-add-sales.component.html',
  styleUrls: ['./edit-add-sales.component.css']
})
export class EditAddSalesComponent implements OnInit {
 ...
 chnagedrop(e)
 {
  ...
  onsubmit(){
    ...
    this.formDataToSend.append("last_name",     JSON.stringify(this.last_name)   );
    ...
    this.formDataToSend.append("is_sales",   JSON.stringify(this.is_sales));
