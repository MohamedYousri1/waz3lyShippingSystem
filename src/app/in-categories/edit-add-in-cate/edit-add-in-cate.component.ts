...
@Component({
  ...
  selector: 'app-edit-add-in-cate',
  templateUrl: './edit-add-in-cate.component.html',
  styleUrls: ['./edit-add-in-cate.component.css']
})

export class EditAddInCateComponent implements OnInit {
  myform!:FormGroup
  ...
  constructor(private fb:FormBuilder,  private ser:InCategoriesService,  private x : MessageService ,  private in_ser:InCategoriesService, private toaster:ToastrService) { }
